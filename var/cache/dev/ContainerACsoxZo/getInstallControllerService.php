...
class getInstallControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.B0HgYdW'] ?? $container->load('get_ServiceLocator_B0HgYdWService'))->withContext('Eccube\\Controller\\Install\\InstallController', $container));
