...
class Eccube_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.YP.F1Xa'] ?? $this->get_ServiceLocator_YP_F1XaService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.L0f1RER'] ?? ($this->privates['.security.request_matcher.L0f1RER'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
