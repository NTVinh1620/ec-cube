...
class getShippingMultipleControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.lENW_ld'] ?? $container->load('get_ServiceLocator_LENWLdService'))->withContext('Eccube\\Controller\\ShippingMultipleController', $container));
